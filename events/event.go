...
// New returns new event
func New[T any]() *event[T] {
    return &event[T]{}
}

// Subscribe subscribes to event and returns unsubscribe function
...
// SubscribeOnce subscribe to event once and returns unsubscribe function.
...
// SubscribeAsync subscribe to event and call subscriber in separate goroutine.
...
// SubscribeOnceAsync subscribe to event and call subscriber in separate goroutine.
