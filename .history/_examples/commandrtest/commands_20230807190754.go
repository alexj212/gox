...
func adminLevelCmd(client io.Writer, cmd *commanCommand, args *commandr.CommandArgs) (err error) {
	//text := args.PealOff(0)
...
func linesCmd(client io.Writer, cmd *Command, args *commandr.CommandArgs) (err error) {
