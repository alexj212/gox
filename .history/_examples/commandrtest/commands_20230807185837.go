...
func debugCmd(client io.Writer, args *commandr.CommandArgs) (err error) {
...
func echoCmd(client io.Writer, args *commandr.CommandArgs) (err error) {
	//text := args.PealOff(0)
	client.Write([]byte(color.GreenString("%v\n", args.PealOff(0))))
	return
}

func exitCmd(client io.Writer, args *commandr.CommandArgs) (err error) {
	client.Write([]byte(color.GreenString("Bye bye 👋\n")))
	client.Close()
	return
}

func tldrCmd(client io.Writer, args *commandr.CommandArgs) (err error) {
	err = args.Parse()
	if err != nil {
		return err
	}
...
func adminLevelCmd(client io.Writer, args *commandr.CommandArgs) (err error) {
	//text := args.PealOff(0)
...
func linesCmd(client io.Writer, args *commandr.CommandArgs) (err error) {
