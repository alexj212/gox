...
func TestCommandArgsSingleCmdParse(t *testing.T) {
	...
	cmdArgs, err := NewCommandArgs("hello", nil)
...
func TestCommandArgsCmdParse(t *testing.T) {
	...
	cmdArgs, err := NewCommandArgs("hello world", nil)
...
func TestCommandArgsTopicParse(t *testing.T) {
	...
	cmdArgs, err := NewCommandArgs("topic hello world stinky", nil)
...
func TestCommandArgsCmdShiftParse(t *testing.T) {
	...
	cmdArgs, _ := NewCommandArgs("entry session mQn5owrjKEdKZFB7BgeWA6JB9ypOvL", nil)
...
//
//     cmdArgs, _ := NewCommandArgs("hello \"world, suckers\"", nil)
//
//     if cmdArgs != nil {
//         t.Errorf("Command Args should error on zero len string")
//     }
...
//
//     cmdArgs, _ := NewCommandArgs("hello \"world, suckers\" alex", nil)
//
//     if cmdArgs != nil {
//         t.Errorf("Command Args should error on zero len string")
//     }
...
//
//     cmdArgs, _ := NewCommandArgs("entry debug a \"quoted variable\" ", nil)
//
//     newCmdLine, _ := cmdArgs.Shift()
//
//     if newCmdLine != nil {
