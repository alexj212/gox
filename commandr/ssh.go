...
type SshService interface {
    ...
    RegisterUser(user string, level ExecLevel, keys []string, history []string)
...
// RegisterUser register a user on the system
func (svc *sshService) RegisterUser(user string, level ExecLevel, keys []string, history []string) {
